...
const ModifyComponent = () => {
  ...
  return (
    <>
      {/* {result ? <ResultModal title={"회원 정보"} content={"수정 완료"} callbackrFn={closeModal} /> : <></>} */}
      <form>
        <div className="space-y-12">
          <div className="border-b border-gray-900/10 pb-12">
            <h2 className="text-base font-semibold leading-7 text-gray-900">Modify</h2>
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                <label className="block text-sm font-medium leading-6 text-gray-900">Nickname</label>
                <div className="mt-2">
                  <input
                    type="text"
                    name="nickname"
